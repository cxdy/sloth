...
- [type Alerting](<#Alerting>)
  ...
  - [func \(a Alerting\) ResolvedPageAlert\(\) \(Alert, error\)](<#Alerting.ResolvedPageAlert>)
  - [func \(a Alerting\) ResolvedTicketAlert\(\) \(Alert, error\)](<#Alerting.ResolvedTicketAlert>)
  - [func \(a \*Alerting\) UnmarshalJSON\(data \[\]byte\) error](<#Alerting.UnmarshalJSON>)
...
<a name="Alert"></a>
## type [Alert](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/types.go#L179-L192>)
...
<a name="Alerting"></a>
## type [Alerting](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/types.go#L145-L176>)
...
### func \(\*Alerting\) [DeepCopy](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L69>)
...
<a name="Alerting.ResolvedPageAlert"></a>
### func \(Alerting\) [ResolvedPageAlert](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/alerting.go#L26>)
...
<a name="Alerting.ResolvedTicketAlert"></a>
### func \(Alerting\) [ResolvedTicketAlert](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/alerting.go#L33>)
...
<a name="Alerting.UnmarshalJSON"></a>
### func \(\*Alerting\) [UnmarshalJSON](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/alerting.go#L12>)
...
It rejects documents that set both a canonical MWMB class key and its alias \(pageAlert and high, or ticketAlert and low\), including empty objects.
...
### func \(\*PrometheusServiceLevel\) [DeepCopy](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L89>)
...
### func \(\*PrometheusServiceLevel\) [DeepCopyInto](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L79>)
...
### func \(\*PrometheusServiceLevel\) [DeepCopyObject](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L99>)
...
## type [PrometheusServiceLevelList](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/types.go#L251-L256>)
...
### func \(\*PrometheusServiceLevelList\) [DeepCopy](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L122>)
...
### func \(\*PrometheusServiceLevelList\) [DeepCopyInto](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L107>)
...
### func \(\*PrometheusServiceLevelList\) [DeepCopyObject](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L132>)
...
### func \(\*PrometheusServiceLevelSpec\) [DeepCopy](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L165>)
...
### func \(\*PrometheusServiceLevelSpec\) [DeepCopyInto](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L140>)
...
## type [PrometheusServiceLevelStatus](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/types.go#L232-L246>)
...
### func \(\*PrometheusServiceLevelStatus\) [DeepCopy](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L185>)
...
### func \(\*PrometheusServiceLevelStatus\) [DeepCopyInto](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L175>)
...
### func \(\*SLI\) [DeepCopy](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L216>)
...
### func \(\*SLI\) [DeepCopyInto](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L195>)
...
### func \(\*SLIEvents\) [DeepCopy](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L232>)
...
### func \(\*SLIEvents\) [DeepCopyInto](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L226>)
...
### func \(\*SLIPlugin\) [DeepCopy](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L255>)
...
### func \(\*SLIPlugin\) [DeepCopyInto](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L242>)
...
### func \(\*SLIRaw\) [DeepCopy](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L271>)
...
### func \(\*SLIRaw\) [DeepCopyInto](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L265>)
...
### func \(\*SLO\) [DeepCopy](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L301>)
...
### func \(\*SLO\) [DeepCopyInto](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L281>)
...
<a name="SLOPlugin"></a>
## type [SLOPlugin](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/types.go#L210-L230>)
...
### func \(\*SLOPlugin\) [DeepCopy](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L322>)
...
### func \(\*SLOPlugin\) [DeepCopyInto](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L311>)
...
<a name="SLOPlugins"></a>
## type [SLOPlugins](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/types.go#L196-L207>)
...
### func \(\*SLOPlugins\) [DeepCopy](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L345>)
...
### func \(\*SLOPlugins\) [DeepCopyInto](<https://github.com/slok/sloth/blob/main/pkg/kubernetes/api/sloth/v1/zz_generated.deepcopy.go#L332>)
