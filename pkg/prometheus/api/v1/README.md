...
<a name="Alert"></a>
## type [Alert](<https://github.com/slok/sloth/blob/main/pkg/prometheus/api/v1/v1.go#L167-L176>)
...
<a name="Alerting"></a>
## type [Alerting](<https://github.com/slok/sloth/blob/main/pkg/prometheus/api/v1/v1.go#L144-L164>)
...
### func \(Alerting\) [ResolvedPageAlert](<https://github.com/slok/sloth/blob/main/pkg/prometheus/api/v1/alerting.go#L26>)
...
### func \(Alerting\) [ResolvedTicketAlert](<https://github.com/slok/sloth/blob/main/pkg/prometheus/api/v1/alerting.go#L33>)
...
### func \(\*Alerting\) [UnmarshalJSON](<https://github.com/slok/sloth/blob/main/pkg/prometheus/api/v1/alerting.go#L12>)
...
It rejects documents that set both a canonical MWMB class key and its alias \(page\_alert and high, or ticket\_alert and low\), including empty objects.
...
<a name="SLOPlugin"></a>
## type [SLOPlugin](<https://github.com/slok/sloth/blob/main/pkg/prometheus/api/v1/v1.go#L192-L204>)
...
<a name="SLOPlugins"></a>
## type [SLOPlugins](<https://github.com/slok/sloth/blob/main/pkg/prometheus/api/v1/v1.go#L180-L189>)
