...
type Alerting struct {
	...
	// PageAlert is the high-burn MWMB alert class (JSON/YAML key "page_alert").
	// high is an accepted alias of this key; page_alert and high must not both be set.
	PageAlert Alert `json:"page_alert,omitempty"`
	// TicketAlert is the low-burn MWMB alert class (JSON/YAML key "ticket_alert").
	// low is an accepted alias of this key; ticket_alert and low must not both be set.
	TicketAlert Alert `json:"ticket_alert,omitempty"`
	// High is an optional alias of PageAlert (JSON/YAML key "high").
	// Mutually exclusive with page_alert.
	High Alert `json:"high,omitempty"`
	// Low is an optional alias of TicketAlert (JSON/YAML key "low").
	// Mutually exclusive with ticket_alert.
